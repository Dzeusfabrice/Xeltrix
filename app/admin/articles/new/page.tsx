                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4 h-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-slate-400">Publier une nouvelle actualité</span>
                        </div>
                    </div>
                </div>
            </nav>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-black/20 border border-white/10 rounded-2xl py-4 px-4 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all font-medium placeholder:text-slate-600 resize-none"
                                ></textarea>
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="content" className="text-sm font-bold text-slate-300">Contenu de l'article * (Supporte l'HTML basique)</label>
                                <textarea
                                    name="content"
                                    id="content"
                                    required
                                    ...
                                    className="w-full bg-black/20 border border-white/10 rounded-2xl py-4 px-4 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all font-medium placeholder:text-slate-600 font-mono text-sm"
                                ></textarea>
                                <p className="text-xs text-slate-500 font-mono">Format accepté pour le moment : texte simple ou balises HTML (&lt;h2&gt;, &lt;p&gt;, &lt;br&gt;, &lt;strong&gt;, etc.)</p>
                            </div>
                        </div>
