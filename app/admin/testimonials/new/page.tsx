                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4 h-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-slate-500 dark:text-slate-400 font-medium tracking-wide">Élargissez votre preuve sociale</span>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <Container className="pt-12 max-w-3xl">
                <div className="p-8 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-white/10 rounded-3xl shadow-2xl relative overflow-hidden glass-card">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        ...
                        <div className="p-6 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl flex items-center justify-between group hover:bg-slate-100 dark:hover:bg-white/10 transition-all">
                            ...
                            <input
                                type="checkbox"
                                name="is_featured"
                                className="w-6 h-6 rounded-lg bg-slate-50 dark:bg-black border-slate-200 dark:border-white/10 accent-pink-500 cursor-pointer"
                            />
                        </div>
