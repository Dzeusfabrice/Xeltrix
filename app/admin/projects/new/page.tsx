                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-4 h-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-slate-500 dark:text-slate-400">Ajouter une réalisation au portfolio</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label htmlFor="title" className="text-sm font-bold text-slate-600 dark:text-slate-300">Titre du Projet *</label>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl py-4 px-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all font-medium placeholder:text-slate-500 dark:placeholder:text-slate-400"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl py-4 px-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all font-medium appearance-none"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label htmlFor="project_url" className="text-sm font-bold text-slate-600 dark:text-slate-300">Lien du projet (URL)</label>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label htmlFor="technologies" className="text-sm font-bold text-slate-600 dark:text-slate-300">Technologies (1 par ligne ou séparées par des virgules)</label>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl py-4 px-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all font-medium placeholder:text-slate-500 dark:placeholder:text-slate-400 resize-none font-mono text-sm"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2 h-full flex flex-col">
                                    ...
                                    <label htmlFor="description" className="text-sm font-bold text-slate-600 dark:text-slate-300">Courte Description *</label>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full flex-grow bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl py-4 px-4 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all font-medium placeholder:text-slate-500 dark:placeholder:text-slate-400 resize-none"
                        ...
                        <div className="space-y-6 pt-6 border-t border-slate-200 dark:border-white/10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label htmlFor="image_file" className="text-sm font-bold text-slate-600 dark:text-slate-300 flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-2xl py-3 px-4 text-slate-900 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-bold file:bg-blue-600 file:text-white hover:file:bg-blue-700 transition-all cursor-pointer"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <label htmlFor="image_url" className="text-sm font-bold text-slate-600 dark:text-slate-300 flex items-center gap-2">
