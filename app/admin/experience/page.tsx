                    ...
                    <div className="flex items-center justify-between h-20">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-slate-400">Gérez votre expertise technique</span>
                            </div>
                        </div>
            ...
            <Container className="pt-12">
                {error ? (
                    ...
                    <div className="text-center py-24 border border-white/10 border-dashed rounded-3xl bg-slate-900/30">
                        ...
                        <h3 className="text-xl font-bold text-white mb-2">Aucun domaine trouvé</h3>
                        <p className="text-slate-400 mb-6">Définissez vos domaines d'expertise (ex: Mobile, Web, Cloud).</p>
                        <Link href="/admin/experience/new">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {skills?.map((s) => (
                            <div key={s.id} className="p-8 bg-slate-900/40 border border-white/10 rounded-[2rem] hover:border-blue-500/30 transition-all glass-card group">
                                ...
                                <h3 className="text-2xl font-black text-white mb-2 tracking-tight group-hover:text-blue-400 transition-all">{s.name}</h3>
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-xs font-black text-white">{s.level}%</span>
                                </div>
                                <p className="text-slate-400 text-sm font-medium italic mb-6">"{s.tech}"</p>
                                <span className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] uppercase font-black tracking-widest text-slate-500">
                                    {s.domain || 'Expertise'}
                                </span>
                            </div>
                        ))}
