...
import { Database, Layout, Smartphone, Cloud, Code2, Figma, Zap, Cpu, GraduationCap } from 'lucide-react'

const skills = [
    { icon: <Smartphone />, name: "Mobile Development", level: 95, tech: "Flutter, React Native, Kotlin", color: "from-blue-500 to-cyan-400" },
    { icon: <Layout />, name: "Web Development", level: 98, tech: "Next.js, React, Tailwind, Node.js", color: "from-purple-600 to-pink-500" },
    { icon: <Figma />, name: "UI/UX Design", level: 90, tech: "Figma, Prototyping, Design Systems", color: "from-orange-500 to-yellow-400" },
    { icon: <Cloud />, name: "Cloud Solutions", level: 85, tech: "Supabase, Firebase, AWS", color: "from-blue-600 to-indigo-500" },
    { icon: <Database />, name: "Database Design", level: 92, tech: "PostgreSQL, MySQL, MongoDB", color: "from-emerald-500 to-teal-400" },
    { icon: <Code2 />, name: "DevOps", level: 80, tech: "Vercel, Docker, GitHub Actions", color: "from-slate-400 to-slate-600" }
]
        ...
        <div className="min-h-screen bg-[#020617] pb-24">
            ...
            <section className="relative py-32 overflow-hidden border-b border-white/5">
                ...
                >
                    ...
                    {/* Seamless symbiosis gradient masks */}
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${skill.color} text-white flex items-center justify-center p-3 shadow-lg transform group-hover:scale-110 transition-transform duration-500`}>
                                            {React.cloneElement(skill.icon as any, { size: 28 })}
                                        </div>
                                        <div>
