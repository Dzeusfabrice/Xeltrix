                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-secondary hover:border-secondary transition-all shadow-xl">
                                <Linkedin size={20} />
                            </a>
                            <a href="#" className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-secondary hover:border-secondary transition-all shadow-xl">
                                <Github size={20} />
                    ...
                    <div>
                        <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-secondary">Navigation</h4>
                    ...
                    {/* Contact Info */}
                    <div>
                        <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-secondary">Contact</h4>
                    ...
                    {/* Newsletter / CTA */}
                    <div>
                        <h4 className="font-black text-lg mb-8 uppercase tracking-widest text-secondary">Newsletter</h4>
                        <p className="text-slate-400 mb-6 text-sm italic">Restez informé de nos dernières innovations.</p>
                        <div className="flex gap-2">
                            <input
                                type="email"
                                placeholder="Votre email"
                                className="bg-white/5 border border-white/10 rounded-xl px-5 py-3 text-sm w-full focus:outline-none focus:ring-2 focus:ring-secondary/50 text-white"
                            />
                            <button className="bg-secondary text-white px-6 py-3 rounded-xl text-sm font-black hover:bg-secondary/80 transition-all shadow-lg shadow-secondary/20">
                                OK
                            </button>
                        </div>
                    </div>
